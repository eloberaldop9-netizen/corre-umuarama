...
import { VideoAnaNovaisViolenciaMulher, TOTAL_FRAMES as VMULHER_TOTAL_FRAMES } from './VideoAnaNovaisViolenciaMulher';
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      />
      <Composition
        id="AnaNovais-ViolenciaMulher"
        component={VideoAnaNovaisViolenciaMulher}
        durationInFrames={VMULHER_TOTAL_FRAMES}
        fps={FPS}
        width={WIDTH}
        height={HEIGHT}
      />
