...
// nossa sociedade!"
// Papel off-white limpo. O martelo da Justiça entra como recorte de jornal
// antigo (P&B + halftone). FORTALECENDO / AS LEIS / E A PROTEÇÃO em roxo
// profundo, palavra por palavra, com tracking fechando (4 → -1).
