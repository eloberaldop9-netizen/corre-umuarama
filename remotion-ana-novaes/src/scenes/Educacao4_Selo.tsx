...
import { EDUCACAO_SCENES } from '../educacao-timing';

// Cena 4 — O Selo (vídeo 08) | frames locais 0–140
...
const S = EDUCACAO_SCENES.c4;

export const Educacao4_Selo: React.FC = () => {
  ...
  const bgIn = ci(frame, [0, 20], [0, 1], Easing.inOut(Easing.cubic)); // dissolve sobre a cena 3
